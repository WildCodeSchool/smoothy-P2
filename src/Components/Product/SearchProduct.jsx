...
const Searchproduct = ({ products }) => {
  ...
  const handleChange = () => {
    ...
    useswitch === "Composition"
      ? setSwitch("environement")
      : setSwitch("Composition");
  };
  ...
  useEffect(() => {
    ...
    const getProducts = () => {
      axios.get(url).then(({ data }) => setEquivProducts(data.products));
    };
    getProducts();
  }, [code]);
    ...
    equivProducts &&
      setFilterNutrigrade(
        equivProducts
          .filter(
            (e) =>
              e.nutrition_grades == "a" ||
              e.nutrition_grades == "b" ||
              e.nutrition_grades == "c" ||
              e.nutrition_grades == "d" ||
              e.nutrition_grades == "e"
          )
          .filter((e) => e.brands_tags)
          .filter((e) => e.brands_tags != [])
          .filter((e) => e._id != products[0]._id)
      );
  ...
  const change = () => {
    setText(!isText);
    useText === "clickme"
      ? setUseText("Reduire les allergènes")
      : setUseText("Afficher les allergènes");
  };
        ...
        <div className="container-Product">
          <div className="header-Product">
            ...
            <div className="header-Right-Product">
              <h1 className="generic-Name-Product">
                {products[0].product_name_fr.length >= 81
                  ? products[0].product_name_fr.substring(0, 81)
                  : products[0].product_name_fr}
              </h1>
              <div className="labellls">
                <div className="labels-1">
                  ...
                  products[0].ecoscore_grade != "not-applicable" ? (
                    <img
                      className="eco-score"
                      src={
                        "https://fr.openfoodfacts.org/images/icons/ecoscore-" +
                        products[0].ecoscore_grade +
                        ".svg"
                      }
                      alt={"eco-score"}
                    ...
                    <img
                      className="eco-score"
                      src={
                        "https://fr.openfoodfacts.org/images/icons/ecoscore-unknown.svg"
                      }
                      alt={"eco-score"}
                    />
                  )}
                ...
                <div className="labels-2">
                  <img
                    ...
                    src={
                      "https://fr.openfoodfacts.org/images/misc/nova-group-" +
                ...
                <div className="bio">
                  ...
                  products[0].labels
                    .replace(/ /g, "")
                    .indexOf("ABAgricultureBiologique") !== -1 ? (
                    <img
                      className="nova-group1"
                      src="https://static.openfoodfacts.org/images/lang/en/labels/ab-agriculture-biologique.74x90.svg"
                      alt="nova-group1"
                    />
                  ) : (
                    <span></span>
                  ...
                  {products[0].labels &&
                  products[0].labels.replace(/ /g, "").indexOf("EUOrganic") !==
                    -1 ? (
                    <img
                      className="nova-group2"
                      src="https://world.openfoodfacts.org/images/lang/en/labels/eu-organic.135x90.svg"
                      alt="nova-group2"
                    />
                  ) : (
                    <span></span>
                  ...
                  products[0].labels
                    .replace(/ /g, "")
                    .indexOf("FairtradeInternational") !== -1 ? (
                    <img
                      className="nova-group3"
                      src="https://world.openfoodfacts.org/images/lang/en/labels/fairtrade-international.77x90.svg"
                      alt="nova-group3"
                    />
                  ) : (
                    <span></span>
            ...
            <div className="switch-Midllproduct">
              <div className="composition-Product">
                <button
                  className={
                    isActive
                      ? "environement-Switch-Product2"
                      : "environement-Switch-Product"
                  }
              ...
              <div className="composition-environement-Product show-Environement-Product ">
                {useswitch === "Composition" ? (
                  products[0].ingredients_text ? (
                    ...
                    <p>Aucune information présente sur le produit</p>
                  )
                ) : (
                  <section className="nutrientLevel">
                    ...
                    {products[0].nutrient_levels !== undefined ? (
                      Object.entries(products[0].nutrient_levels).map((e) => (
                        <div className="label">
                          ...
                          <span className={`label--value ${e[1]}`}>
                            {level(e[1])}
                          </span>
                        </div>
                      ))
                    ...
                    {products[0] &&
                      products[0].additives_tags.map((e) => (
                        <p className="additives">
                          {e.replace("en:", "").toUpperCase()}
                        </p>
                      ))}
                  </section>
                )}
          ...
          <Link
            to={`/productListEquiv/${code}`}
            className={
              filterNutrigrade.length > 0 ? "goproductlist" : "productListNone"
            }
          >
            Voir tout
          </Link>
