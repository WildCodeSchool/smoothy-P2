...
const url =
`https://fr.openfoodfacts.org/cgi/search.pl?action=process&tagtype_0=categories&tag_contains_0=contains&tag_0=${cat}&tagtype_1=nutrition_grade_fr&tag_contains_1=contains&tag_1=a&fields=categories,_id,code,product_name_fr,brands_tags,image_front_small_url,image_url,quantity,nutrition_grade_fr,nutrition_grade_fr,nutrition_grades,labels_old,brands,generic_name,_keywords,nutrition_grade_fr,brands_tags&page_size=6&json=true`;
...
<div className="allAlergenes">
  ...
  {products[0].allergens_from_ingredients.split(',').forEach(elt => !elt.startsWith('en:') ?
  arrayFilter.push(elt.trim()):'none')}
      ...
      <div className="header-Right-Product">
        ...
        <div className="labellls">
          <div className="labels-1">
            <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
              products[0].nutrition_grade_fr + ".svg" } alt={''} />
            {/* {products[0].nutrition_grade_fr
            ?<img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
              product.nutrition_grade_fr + ".svg" } alt={''} />
            :<img className='nutri-score'
              src="https://static.openfoodfacts.org/images/attributes/nutriscore-unknown.svg" />} */}
            <img className='eco-score' src={"https://fr.openfoodfacts.org/images/icons/ecoscore-" +
              products[0].ecoscore_grade + ".svg" } alt={''} />
          </div>
          <div className="labels-2">
            <img className='nova-group' src={"https://fr.openfoodfacts.org/images/misc/nova-group-" +
              products[0].nova_group + ".svg" } alt={''} />
          </div>
          ...
          ?<img src="https://static.openfoodfacts.org/images/lang/en/labels/ab-agriculture-biologique.74x90.svg"
            alt="" />
          :<span></span>
          }
    ...
    <div className="midll-Product">
      <div className="switch-Midllproduct">
        <div className="composition-Product">
          <p className={isActive ? "environement-Switch-Product2" : "environement-Switch-Product" }
        ...
        <div className="composition-environement-Product show-Environement-Product ">
          ...
          products[0].ingredients_text ? <p>{dashRemover(products[0].ingredients_text)}</p> : <p>Aucune information
            présente sur le produit</p>
          ) : (
    ...
    <div className="le-grid">
      ...
      <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[0]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[0])+ ".svg"} alt={''} />
        </div>
      </div>
      ...
      <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[1]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[1])+ ".svg"} alt={''} />
        </div>
      </div>
      ...
      <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[2]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[2])+ ".svg"} alt={''} />
        </div>
      </div>

      <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[3]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[3])+ ".svg"} alt={''} />
        </div>
      </div>

      <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[4]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[4])+ ".svg"} alt={''} />
      ...
      <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[5]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[5])+ ".svg"} alt={''} />
        </div>
      </div>

      {/* <div className="propos1 bestchoic">
        <div className="container-Img-Bestchoic">
          <Link to={`/Product/${equivProducts.map((pr)=>pr._id)[6]}`}> <img className="img-Left-Prod"
        ...
        <div className="container-Infos-Bestchoic">
          ...
          <img className='nutri-score' src={"https://fr.openfoodfacts.org/images/misc/nutriscore-" +
            (equivProducts.map((nameP)=>nameP.nutrition_grade_fr)[6])+ ".svg"} alt={''} />
        </div>
      </div> */}
